    ...
    function get($rid, $title, $daysLeft, $amount) {
        echo <<<HTML
            <div class="card mb-4 remainder">
                <div class="remainder-card card-body d-flex justify-content-between align-items-center px-2 py-2 bg-warning bg-gradient remainder-data-holder">
                    <div class="left-side">
                    <input type="hidden" class="rid" value=$rid>

                        <h5 class="data title">$title</h5>
                        <p class="m-0"> <span class="data daysLeft">
                        $daysLeft
                        </span>  days left</p>
                    </div>
